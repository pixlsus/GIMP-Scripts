...
;        (begin
           (plug-in-gmic 1 theImage blurLayer 1 "-v - -gimp_smooth_anisotropic 10,0.16,0.63,0.6,2.35,0.8,30,2,0,1,1,0,1,24") ; apply anisotropic smoothing
...
(script-fu-register "script-fu-hillustrative"
	...
	SF-TOGGLE		_"With tone mapping" TRUE
)
